...
for( type in c('blogs','news','twitter') ) {
     ...
     for( filename in list.files( src ) ) {
          ...
          message( sprintf( ' - content been tokenized and cleaned of number-letter combinations and stopwords', infile ) )
          ...
          for ( n in 4:3 ) {
               ...
               outfile <- sprintf( '%s/nostpwrd_%d-gram_%s.rds', dest, n, cnum )
