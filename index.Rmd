...
* These had several passes of repair made... 
  ...
  * Anything inside parentheses or brackets were removed
  * As were run-on button smashes, like 'aaaaaaaaaaaaahhhh', reduced simply to 'ah'
  * Various common titles, like capt., mr., et cetera were normalized
  
---

## 
  
  which then were reinterpreted as chains of ngrams.
```{r get some counts, message=F, eval=T, echo=F, warning=F }
